...
| Installer overwrite/race         | Install replaces config or uninstall deletes replacement      | Create-only install; inode/byte-pinned uninstall                                                                                   | Installer race/idempotency tests                           |
...
password redaction, and audit no-content checks. It imports broker source and uses
